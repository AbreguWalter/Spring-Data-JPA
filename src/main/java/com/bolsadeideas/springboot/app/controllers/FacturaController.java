...
public class FacturaController {
	...
	//Cuando usamos ajax , es importante usar ResponseBody para que no pida devolver a una vista 
	...
	public String guardar(@Valid Factura factura,BindingResult result,
		...
		log.info("Cantidad :::: "+cantidad.toString());
		//Para verificar si salio un error desde el front
		if(result.hasErrors()) {
